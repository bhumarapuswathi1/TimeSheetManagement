...
public class ProjectManager {
	...
	@NotEmpty
	@Size(max=20,message="P_app_server_id have atleast twocharacter upto 20 character")
	private String proj_app_server_id;
	
	@NotEmpty
	@Size(max=20,message="P_pm_name have atleast twocharacter upto 20 character")
	private String proj_pm_name;
	
	@NotEmpty
	@Size(max=20,message="P_pl have atleast twocharacter upto 20 character")
	private String proj_pl;
	
	@NotEmpty
	@Size(max=20,message="P_notes have atleast twocharacter upto 20 character")
	private String proj_notes;
	
	@NotEmpty
	@Size(max=20,message="P_start_date have atleast twocharacter upto 20 character")
	private Date proj_start_date;
	
	@NotEmpty
	@Size(max=20,message="P_end_date have atleast twocharacter upto 20 character")
	private Date proj_end_date;
	
	@NotEmpty
	@Size(max=20,message="P_status have atleast twocharacter upto 20 character")
	...
	public ProjectManager(int proj_id,
			...
			@NotEmpty @Size(max = 20, message = "P_pm_name have atleast twocharacter upto 20 character") String proj_pm_name,
			@NotEmpty @Size(max = 20, message = "P_pl have atleast twocharacter upto 20 character") String proj_pl,
			@NotEmpty @Size(max = 20, message = "P_notes have atleast twocharacter upto 20 character") String proj_notes,
			@NotEmpty @Size(max = 20, message = "P_status have atleast twocharacter upto 20 character") String status) {
		super();
